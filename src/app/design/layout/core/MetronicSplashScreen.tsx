...
const MetronicSplashScreenProvider: FC<React.PropsWithChildren<unknown>> = ({children}) => {
...
const LayoutSplashScreen: FC<React.PropsWithChildren<{visible?: boolean}>> = ({visible = true}) => {
