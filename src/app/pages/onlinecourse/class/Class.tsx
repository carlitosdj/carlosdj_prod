...
import {loadClassesRequest, loadModulesRequest} from '../../../../store/ducks/component/actions'
...
const Class: FC<React.PropsWithChildren<unknown>> = () => {
  ...
  if (component.loading || component.loadingModules || component.loadingClasses) {
    return <Loading />
  }
