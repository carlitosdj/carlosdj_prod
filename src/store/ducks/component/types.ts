...
export enum ComponentTypes {
  ...
  //Time Watched
  CREATE_TIMEWATCHED_REQUEST = '@component/CREATE_TIMEWATCHED_REQUEST',
  CREATE_TIMEWATCHED_SUCCESS = '@component/CREATE_TIMEWATCHED_SUCCESS',
  CREATE_TIMEWATCHED_FAILURE = '@component/CREATE_TIMEWATCHED_FAILURE',
