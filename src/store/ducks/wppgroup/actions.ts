...
export const loadWppgroupsFailure = (err: any[]) => action(WppgroupTypes.LOAD_WPPGROUPS_FAILURE, err)
...
export const updateWppgroupFailure = (err: any[]) => action(WppgroupTypes.UPDATE_WPPGROUP_FAILURE, err)
